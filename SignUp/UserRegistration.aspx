...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Table ID="tblUserRegistration" runat="server" BorderColor="Black" BorderWidth="1" BorderStyle="Solid" HorizontalAlign="Center" Width="960px">
                <asp:TableHeaderRow>
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                     ...
                     <asp:TableRow>
         <asp:TableCell>
             <asp:Label ID="lblLastName" runat="server" Text="Last Name" Font-Bold="true"></asp:Label><span style="color:red">*</span>
         </asp:TableCell>

         <asp:TableCell>
             <asp:TextBox ID="txtLastName" runat="server" CssClass="txtBox"></asp:TextBox>
             <asp:RequiredFieldValidator ID="rfvLastName" runat="server" ControlToValidate="txtLastName" Display="Dynamic" ForeColor="Red"
             ErrorMessage="Enter Last Name." SetFocusOnError="true" ValidationGroup="Submit"></asp:RequiredFieldValidator>
         </asp:TableCell>
     </asp:TableRow>
      ...
      <asp:TableCell>
          ...
          ErrorMessage="Select Gender." InitialValue="Select Gender" SetFocusOnError="true" ValidationGroup="Submit"></asp:RequiredFieldValidator>
                   ...
                   <asp:TableRow>
       <asp:TableCell>
           <asp:Label ID="lblAddress" runat="server" Text="Address" Font-Bold="true"></asp:Label><span style="color:red">*</span>
       </asp:TableCell>
 ...
 ErrorMessage="Password and Confirm Password's are not matching." SetFocusOnError="true" ValidationGroup="Submit"></asp:CompareValidator>
                ...
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                        <hr />
                        <asp:Button ID="btnSignUp" runat="server" Text="Sign Up" Font-Bold="true" BackColor="YellowGreen" OnClick="btnSignUp_Click" />
